...
%global pkg_name performance_test_fixture
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-performance-test-fixture
Version:        0.2.0
Release:        2%{?dist}
...
%description
Test fixture and CMake macro for using osrf_testing_tools_cpp with Google
Benchmark
...
%changelog
* Wed Mar 20 2024 Alejandro Hernandez Cordero <alejandro@openrobotics.org> - 0.2.0-2
